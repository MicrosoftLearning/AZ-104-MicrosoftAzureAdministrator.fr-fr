...
1. Téléchargez les fichiers du labo **\\Allfiles\\Labs\\11\\az104-11-vm-template.json** sur votre ordinateur.
...
1. Recherchez et sélectionnez le fichier **\\Allfiles\\Labs\\11\\az104-11-vm-template.json**, puis sélectionnez **Ouvrir**.
...
1. Sélectionnez **Activer** à côté de votre machine virtuelle.

1. Acceptez les valeurs par défaut, sélectionnez **Passer en revue + activer**, puis **Activer**.  
...
1. Continuez à travailler sur votre alerte. Accédez à l’onglet **Actions**, sélectionnez **Utiliser les groupes d’actions**, puis sélectionnez **Créer un groupe d’actions** dans le volet **Sélectionner un groupe d’actions**.
...
1. Une fois le groupe d’actions créé, passez à l’onglet **Suivant : Onglet Détails >** et entrez les valeurs suivantes pour chaque paramètre.
...
1. Sélectionnez **Suivant : Détails >** et entrez les paramètres suivants :
