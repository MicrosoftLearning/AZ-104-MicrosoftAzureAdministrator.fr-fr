...
1. Développez le panneau **Gestion DNS** et sélectionnez **+ Ensemble d’enregistrements**. **Ajoutez** un enregistrement de liaison de réseau virtuel pour chaque réseau virtuel qui nécessite la prise en charge de la résolution de noms privés.
